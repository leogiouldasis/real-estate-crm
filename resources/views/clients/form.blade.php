    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form class="form-horizontal form-label-left" novalidate>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="" name="interested_areas[]" data-placeholder="Choose areas..." id="interested_areas"
                            ...
                            <option value="{{$obj}}"
                                {{ isset($client->interested_areas) && in_array($obj, $client->interested_areas) ? 'selected':'' }}>
                                {{$obj}}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Interested Type</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="" name="interest_type" data-placeholder="Choose interest..." id="interest_type"
                            ...
                            <option value="{{$obj}}"
                                {{ isset($client->interest_type) && $client->interest_type === $obj ? 'selected' : '' }}>
                                {{$obj}}
                            </option>
                            @endforeach
                        </select>
